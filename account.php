...
<head>
    ...
    <title>Chào mừng bạn đến Việt Nam</title>
                    ...
                    <div style="width: 100%; text-align:center">
                        <form method="POST">
                            ...
                            <button style="border: 0px; background:none;">
                                <h4 class="menu-account-logout">Đăng xuất</h4>
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-8" id="Information">
                <div class="box-black">
                    <div style="width: 100%;color:#f2f2f2">
                        ...
                        <div id="emaill"
                            style="display:none;background: #f5c6cb;padding: 3px;border-left: #e00 solid 5px;">Email
                            không hợp lệ</div>

                        <div id="passerror"
                            style="display:none;background: #f5c6cb;padding: 3px;border-left: #e00 solid 5px;">Mật khẩu
                            không chính xác</div>
                        <div class="form-group">
                        ...
                        <div id="sdt"
                            style="display:none;background: #f5c6cb;padding: 3px;border-left: #e00 solid 5px;">Số điện
                    ...
                    <div style="width: 100%;color:#f2f2f2">
                        ...
                        <form method="post" action="#" style="margin-top: 30px; margin-bottom: 30px; ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" value="<?php echo $getdata['name'] ?>"
                                    required="" placeholder="Tan Cu Chan" name="name">
                            </div>
                            <div class="form-group">
                                <label for="" style="color: #f2f2f2;">Email</label>
                                <input type="text" class="form-control" id="email"
                                    value="<?php echo $getdata['email'] ?>" required=""
                                    placeholder="nguyenvana@gmail.com" name="email">
                            </div>
                            <div id="emaill"
                                style="display:none;background: #f5c6cb;padding: 3px;border-left: #e00 solid 5px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="phonenumber"
                                    value="<?php echo $getdata['phonenumber'] ?>" required="" placeholder="0347194217"
                                    name="phonenumber">
                            </div>
                            <div id="sdt"
                                style="display:none;background: #f5c6cb;padding: 3px;border-left: #e00 solid 5px;">
                                Số điện thoại không khớp</div>
                            <div class="form-group">
                                <label for="" style="color: #f2f2f2;">Địa chỉ</label>
                                <input type="text" class="form-control" id="address"
                                    value="<?php echo $getdata['address'] ?>" required="" placeholder="Can Tho"
                                    name="address">
                            </div>
                            <div style="text-align: center"><button style="margin-top: 10px;"
                                    class="btn btn-secondary">Thay đổi thông tin</button></div>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <form method="post" action="#" style="margin-top: 30px; margin-bottom: 30px">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password" required=""
                                    placeholder="Nhập mật khẩu cảu bạn" name="oldpassword">
                            </div>

                            <div class="form-group">
                                <label for="" style="color: #f2f2f2;">Mật khẩu mới</label>
                                <input type="password" class="form-control" id="password" required=""
                                    placeholder="Nhập mật khẩu mới của bạn" name="new1password">
                            </div>
                            <div class="form-group">
                                <label for="" style="color: #f2f2f2;">Xác nhận mật khẩu</label>
                                <input type="password" class="form-control" id="password2" required=""
                                    placeholder="Nhập mật khẩu xác nhận của bạn" name="new2password">
                            </div>

                            <div style="text-align: center"><button style="margin-top: 10px;"
                                    class="btn btn-secondary">Thay đổi mật khẩu</button></div>
                        </form>
                    </div>
                </div>
            </div>
