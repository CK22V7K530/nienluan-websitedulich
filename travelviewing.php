    ...
    ?>
        ...
        <div class="row">
                ...
                <div id="mycarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img class="d-block w-100" style="width: 100%; height:400px; "
                                src="<?php echo $getdata[1]; ?>">
                        ...
                        <div class="carousel-item">
                            <img style="width: 100%; height:400px;" class="d-block w-100"
                                src="<?php echo $getdata[2]; ?>">
                        </div>
                        <!--Slide 3-->
                        <div class="carousel-item">
                            <img style="width: 100%; height:400px;" class="d-block w-100"
                                src="<?php echo $getdata[3]; ?>">
                        </div>
            ...
            <div class="col-4" style="background: #eee;">
                <h3 style="color: #CD5555;">Mô tả về chuyến đi</h3>
                <table>
                    <tr>
                    <tr>
                        <td><i class="fas fa-barcode"></i></td>
                        <td style="padding-left: 10px;"><b>Mã du lịch:</b><span
                                style="color:  #ff9900;"><?php echo $getdata[6]; ?></span></td>
                    </tr>
                    <tr>
                        <td><i class="fas fa-calendar-alt"></i></td>
                        <td style="padding-left: 10px;"><b>Ngày khởi hành: </b><span
                                style="color:  #ff9900;"><?php echo $getdata[7]; ?></span></td>
                    </tr>
                    <tr>
                        <td><i class="far fa-clock"></i></td>
                        <td style="padding-left: 10px;"><b>Thời gian: </b><span style="color:  #ff9900;">
                                <?php echo $getdata[8]; ?> day</span></td>
                    </tr>
                    <tr>
                        <td> <i class="fas fa-plane-departure"></i></td>
                        <td style="padding-left: 10px;"><b>Nơi xuất phát: </b> <span
                                style="color:  #ff9900;"><?php echo $getdata[9]; ?></span></td>
                    </tr>
                    <tr>
                        <td> <i class="fas fa-plane-arrival"></i></td>
                        <td style="padding-left: 10px;"><b>Địa điểm đến</b><span
                                style="color:  #ff9900;"><?php echo $getdata[10]; ?></span></td>
                    </tr>
                    <tr>
                        <td> <i class="fas fa-chair"></i></td>
                        <td style="padding-left: 10px;"><b>Số chỗ ngồi: </b><span style="color: #ff9900;">
                                <?php echo $getdata[11]; ?></span></td>
                    </tr>
                </table>
                <div
                    style=" font-weight: 500;background: #f57d00; text-align:center; position:absolute; bottom:20px; width:92%; height:40px; color:#eee; line-height:40px;">
            ...
            <div style="width: 100%; border-radius: 3px; padding: 10px">
                <?php if(isset($_SESSION['email'])) echo ' <form method="post">
                       ...
                       ';
                            ...
                            echo '<span>Vui lòng <a href="./login.php">Đăng nhập</a> để bình luận !!</span>';
                        }
                       ?>

                <hr>
                <span style="font-size: 13px; margin-left:10px; position:relative; top:-20px;">Có tất cả
                    <?php echo $getCount ?> bình luận</span>
